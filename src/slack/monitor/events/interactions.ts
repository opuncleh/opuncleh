...
// Prefix for Opuncleh-generated action IDs to scope our handler
const OPUNCLEH_ACTION_PREFIX = "opuncleh:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${OPUNCLEH_ACTION_PREFIX}`);

  // Handle Opuncleh modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
