...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: OpunclehConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: OpunclehConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__opunclehMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__opunclehMcporterColdStartWarned;
  });
