...
function resolveAcpStreamCoalesceIdleMs(cfg: OpunclehConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: OpunclehConfig): number {
...
export function resolveAcpProjectionSettings(cfg: OpunclehConfig): AcpProjectionSettings {
