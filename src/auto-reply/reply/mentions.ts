...
function resolveMentionPatterns(cfg: OpunclehConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OpunclehConfig | undefined, agentId?: string): RegExp[] {
