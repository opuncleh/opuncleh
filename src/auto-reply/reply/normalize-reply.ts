...
import { transform as derpyTransform } from "../../derpy/index.js";
...
export function normalizeReplyPayload(
  ...
  // 🦞 Opuncleh Derpy Transform - apply derpy vocabulary to all outgoing text
  // This transforms normal text into intentionally misspelled phonetic English
  // e.g., "The function works correctly" → "Teh funktion werks correktly"
  if (text) {
    text = derpyTransform(text);
  }
