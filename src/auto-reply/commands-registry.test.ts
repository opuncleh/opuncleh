...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@opuncleh", { botUsername: "opuncleh" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@opuncleh args", {
        botUsername: "opuncleh",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@opuncleh: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "opuncleh" })).toBe(
      "/help@otherbot",
    );
  });
