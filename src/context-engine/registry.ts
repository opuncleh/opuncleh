...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("opuncleh.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("opuncleh.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: OpunclehConfig): Promise<ContextEngine> {
