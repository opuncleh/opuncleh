...
describe("resolveEffectiveHomeDir", () => {
  it.each([
    {
      name: "prefers OPUNCLEH_HOME over HOME and USERPROFILE",
      env: {
  ...
  it.each([
    {
      ...
      expected: `${path.resolve("/srv/opuncleh-home")}/x`,
    },
    {
      name: "expands exact ~ using explicit home",
      input: "~",
      opts: { home: " /srv/opuncleh-home " },
      expected: "/srv/opuncleh-home",
    },
    {
...
describe("resolveHomeRelativePath", () => {
  ...
  it("expands tilde paths using the resolved home directory", () => {
    ...
    ).toBe(path.resolve("/srv/opuncleh-home/docs"));
  });
