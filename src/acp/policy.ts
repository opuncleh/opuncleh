...
export function isAcpEnabledByPolicy(cfg: OpunclehConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: OpunclehConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: OpunclehConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: OpunclehConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: OpunclehConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: OpunclehConfig, agentId: string): boolean {
