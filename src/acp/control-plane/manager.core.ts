...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: OpunclehConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: OpunclehConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: OpunclehConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: OpunclehConfig }): Promise<void> {
