...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.OPUNCLEH_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.OPUNCLEH_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.OPUNCLEH_SERVICE_MARKER = originalServiceMarker;
    }
  });
