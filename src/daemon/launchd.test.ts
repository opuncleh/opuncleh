...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.opuncleh.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.opuncleh.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", OPUNCLEH_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://www.opuncleh.com/docs.html/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when OPUNCLEH_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.opuncleh.gateway.plist",
    },
    {
      name: "uses profile-specific label when OPUNCLEH_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", OPUNCLEH_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.opuncleh.jbphoenix.plist",
    },
    {
      name: "prefers OPUNCLEH_LAUNCHD_LABEL over OPUNCLEH_PROFILE",
      env: {
        HOME: "/Users/test",
        OPUNCLEH_PROFILE: "jbphoenix",
        OPUNCLEH_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from OPUNCLEH_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        OPUNCLEH_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty OPUNCLEH_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        OPUNCLEH_PROFILE: "myprofile",
        OPUNCLEH_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.opuncleh.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
