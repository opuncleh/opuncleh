...
const ensureOpunclehModelsJsonMock = vi.fn(async () => {});
...
vi.mock("../../agents/models-config.js", () => ({
  ensureOpunclehModelsJson: ensureOpunclehModelsJsonMock,
}));
...
describe("describeImageWithModel", () => {
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    ...
    expect(ensureOpunclehModelsJsonMock).toHaveBeenCalled();
