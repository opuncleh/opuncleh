...
function resolveSpeechProviderPluginEntries(cfg?: OpunclehConfig): SpeechProviderPlugin[] {
...
export function listSpeechProviders(cfg?: OpunclehConfig): SpeechProviderPlugin[] {
