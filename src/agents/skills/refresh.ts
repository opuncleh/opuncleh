...
function resolveWatchPaths(workspaceDir: string, config?: OpunclehConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OpunclehConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpunclehConfig }) {
