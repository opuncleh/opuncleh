...
function resolveAnthropicOpusThinking(cfg: OpunclehConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<OpunclehConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<OpunclehConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<OpunclehConfig> = {
        agents: {
          defaults: {
            models: {
