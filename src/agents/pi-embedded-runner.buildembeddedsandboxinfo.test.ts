...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/opuncleh-sandbox",
    agentWorkspaceDir: "/tmp/opuncleh-workspace",
    workspaceAccess: "none",
    runtimeId: "opuncleh-sbx-test",
    runtimeLabel: "opuncleh-sbx-test",
    containerName: "opuncleh-sbx-test",
    ...
    browser: {
      ...
      containerName: "opuncleh-sbx-browser-test",
    },
