...
const CLEANUP_STATE_KEY = Symbol.for("opuncleh.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("opuncleh.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("opuncleh.sessionWriteLockWatchdogState");
