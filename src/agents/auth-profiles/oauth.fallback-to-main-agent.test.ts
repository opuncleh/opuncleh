...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOpunclehAgentDir() returns mainAgentDir
    process.env.OPUNCLEH_STATE_DIR = tmpDir;
    process.env.OPUNCLEH_AGENT_DIR = mainAgentDir;
