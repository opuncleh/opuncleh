...
type ModelsConfig = NonNullable<OpunclehConfig["models"]>;
...
export function normalizeGoogleModelId(id: string): string {
  ...
  // Preserve compatibility with earlier Opuncleh docs/config that pointed at a
...
export async function resolveImplicitCopilotProvider(params: {
  ...
  // Opuncleh keeps auth in auth-profiles and resolves runtime availability from that store.
