...
type AgentEntry = NonNullable<NonNullable<OpunclehConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: OpunclehConfig): AgentEntry[] {
...
export function listAgentIds(cfg: OpunclehConfig): string[] {
...
export function resolveDefaultAgentId(cfg: OpunclehConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: OpunclehConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: OpunclehConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: OpunclehConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: OpunclehConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
