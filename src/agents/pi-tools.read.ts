...
function resolveAdaptiveReadMaxBytes(options?: OpunclehReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOpunclehReadTool(base, {
...
export function createOpunclehReadTool(
  base: AnyAgentTool,
  options?: OpunclehReadToolOptions,
): AnyAgentTool {
