...
function resolveMemoryToolContext(options: { config?: OpunclehConfig; agentSessionKey?: string }) {
...
async function getMemoryManagerContext(params: { cfg: OpunclehConfig; agentId: string }): Promise<
  | {
...
function createMemoryTool(params: {
  ...
  execute: (ctx: { cfg: OpunclehConfig; agentId: string }) => AnyAgentTool["execute"];
}): AnyAgentTool | null {
...
function resolveMemoryCitationsMode(cfg: OpunclehConfig): MemoryCitationsMode {
