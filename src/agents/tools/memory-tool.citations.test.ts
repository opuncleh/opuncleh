...
function asOpunclehConfig(config: Partial<OpunclehConfig>): OpunclehConfig {
...
function createMemoryGetToolOrThrow(config: OpunclehConfig = createToolConfig()) {
