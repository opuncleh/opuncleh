...
describe("gateway tool defaults", () => {
  const envSnapshot = {
    opuncleh: process.env.OPUNCLEH_GATEWAY_TOKEN,
  ...
  afterAll(() => {
    if (envSnapshot.opuncleh === undefined) {
      delete process.env.OPUNCLEH_GATEWAY_TOKEN;
    } else {
      process.env.OPUNCLEH_GATEWAY_TOKEN = envSnapshot.opuncleh;
    }
  ...
  it("uses OPUNCLEH_GATEWAY_TOKEN for allowlisted local overrides", () => {
  ...
  it("does not leak local env/config tokens to remote overrides", () => {
    process.env.OPUNCLEH_GATEWAY_TOKEN = "local-env-token";
