...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/opuncleh/opuncleh/issues/31298
    previousFastTestEnv = process.env.OPUNCLEH_TEST_FAST;
  ...
  afterAll(() => {
    if (previousFastTestEnv === undefined) {
      delete process.env.OPUNCLEH_TEST_FAST;
      return;
    }
    process.env.OPUNCLEH_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // OPUNCLEH_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("Opuncleh runtime context (internal):");
