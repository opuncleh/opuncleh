...
export const createOpunclehCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createOpunclehCodingToolsMock.mockReset();
  createOpunclehCodingToolsMock.mockReturnValue([]);
}
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureOpunclehModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveOpunclehDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createOpunclehCodingTools: createOpunclehCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveOpunclehAgentDir: vi.fn(() => "/tmp"),
  }));
