...
function resolvePostCompactionIndexSyncMode(config?: OpunclehConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureOpunclehModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createOpunclehCodingTools({
      exec: {
