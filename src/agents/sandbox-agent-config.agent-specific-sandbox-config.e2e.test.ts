...
async function resolveContext(config: OpunclehConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): OpunclehConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
