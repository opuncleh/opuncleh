...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("opuncleh-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("opuncleh-cache-test1-");
    const workspace2 = await makeTempWorkspace("opuncleh-cache-test2-");
