...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "opuncleh-sbx-test",
    runtimeLabel: params.containerName ?? "opuncleh-sbx-test",
    containerName: params.containerName ?? "opuncleh-sbx-test",
