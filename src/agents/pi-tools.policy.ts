...
export function resolveSubagentToolPolicy(cfg?: OpunclehConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: OpunclehConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: OpunclehConfig["tools"];
