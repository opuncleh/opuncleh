...
const OPUNCLEH_ATTRIBUTION_PRODUCT = "Opuncleh";
const OPUNCLEH_ATTRIBUTION_ORIGINATOR = "opuncleh";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: OPUNCLEH_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: OPUNCLEH_ATTRIBUTION_ORIGINATOR,
      "User-Agent": `${OPUNCLEH_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
