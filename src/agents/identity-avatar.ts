...
function resolveAvatarSource(cfg: OpunclehConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpunclehConfig, agentId: string): AgentAvatarResolution {
