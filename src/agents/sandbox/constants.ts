...
export const DEFAULT_SANDBOX_IMAGE = "opuncleh-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "opuncleh-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "opuncleh-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "opuncleh-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "opuncleh-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "opuncleh-sandbox-browser";
