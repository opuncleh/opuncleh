...
let originalOpunclehTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalOpunclehTestConsole = process.env.OPUNCLEH_TEST_CONSOLE;
  process.env.OPUNCLEH_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalOpunclehTestConsole === undefined) {
    delete process.env.OPUNCLEH_TEST_CONSOLE;
  } else {
    process.env.OPUNCLEH_TEST_CONSOLE = originalOpunclehTestConsole;
  }
