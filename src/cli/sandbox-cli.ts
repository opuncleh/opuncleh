...
const SANDBOX_EXAMPLES = {
  main: [
    ["opuncleh sandbox list", "List all sandbox containers."],
    ["opuncleh sandbox list --browser", "List only browser containers."],
    ["opuncleh sandbox recreate --all", "Recreate all containers."],
    ["opuncleh sandbox recreate --session main", "Recreate a specific session."],
    ["opuncleh sandbox recreate --agent mybot", "Recreate agent containers."],
    ["opuncleh sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["opuncleh sandbox list", "List all sandbox containers."],
    ["opuncleh sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["opuncleh sandbox recreate --all", "Recreate all containers."],
    ["opuncleh sandbox recreate --session main", "Recreate a specific session."],
    ["opuncleh sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["opuncleh sandbox recreate --browser --all", "Recreate only browser containers."],
    ["opuncleh sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["opuncleh sandbox explain", "Show effective sandbox config."],
    ["opuncleh sandbox explain --session agent:main:main", "Explain a specific session."],
    ["opuncleh sandbox explain --agent work", "Explain an agent sandbox."],
    ["opuncleh sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.opuncleh.com/cli/sandbox")}\n`,
    )
    .action(() => {
