    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["opuncleh directory self --channel slack", "Show the connected account identity."],
          [
            'opuncleh directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["opuncleh directory groups list --channel discord", "List available groups/channels."],
          [
            "opuncleh directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.opuncleh.io/cli/directory",
        )}\n`,
    )
    .action(() => {
