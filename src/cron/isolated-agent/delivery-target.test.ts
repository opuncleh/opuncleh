...
function makeCfg(overrides?: Partial<OpunclehConfig>): OpunclehConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
function makeTelegramBoundCfg(accountId = "account-b"): OpunclehConfig {
  return makeCfg({
    bindings: [
      {
        agentId: AGENT_ID,
...
async function resolveLastTarget(cfg: OpunclehConfig) {
