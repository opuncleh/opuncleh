...
export function listAuthProfileStorePaths(config: OpunclehConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: OpunclehConfig, stateDir: string): string[] {
