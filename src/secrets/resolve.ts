...
function resolveResolutionLimits(config: OpunclehConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: OpunclehConfig): SecretProviderConfig {
