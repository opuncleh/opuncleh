...
describe("gateway auth", () => {
  ...
  it("resolves token/password from OPUNCLEH gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          OPUNCLEH_GATEWAY_TOKEN: "env-token",
          OPUNCLEH_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides OPUNCLEH_GATEWAY_PASSWORD", () => {
