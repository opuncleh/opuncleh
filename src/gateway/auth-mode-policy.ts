...
export function hasAmbiguousGatewayAuthModeConfig(cfg: OpunclehConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: OpunclehConfig): void {
