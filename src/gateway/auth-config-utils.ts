import type { GatewayAuthConfig, OpunclehConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: OpunclehConfig, password: string): OpunclehConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
