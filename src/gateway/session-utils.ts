...
import { type OpunclehConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpunclehConfig): string[] {
...
export function listAgentsForGateway(cfg: OpunclehConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpunclehConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpunclehConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OpunclehConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
  const storeConfig = cfg.session?.store;
...
export function getSessionDefaults(cfg: OpunclehConfig): GatewaySessionsDefaults {
