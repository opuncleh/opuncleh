...
export function listChannelMessageActions(cfg: OpunclehConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: OpunclehConfig): boolean {
...
export function supportsChannelMessageCards(cfg: OpunclehConfig): boolean {
