...
export type ChannelAgentToolFactory = (params: { cfg?: OpunclehConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OpunclehConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: OpunclehConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OpunclehConfig }) => boolean;
  supportsCards?: (params: { cfg: OpunclehConfig }) => boolean;
