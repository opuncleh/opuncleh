...
import { discoverOpunclehPlugins } from "../../plugins/discovery.js";
import type { OpunclehPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, OpunclehPackageManifest>>;

const ENV_CATALOG_PATHS = ["OPUNCLEH_PLUGIN_CATALOG_PATHS", "OPUNCLEH_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<OpunclehPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: OpunclehPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: OpunclehPackageManifest;
