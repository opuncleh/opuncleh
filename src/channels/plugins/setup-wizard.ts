...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: OpunclehConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: OpunclehConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: OpunclehConfig;
    accountId: string;
  }) => OpunclehConfig | Promise<OpunclehConfig>;
};
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: OpunclehConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: OpunclehConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: OpunclehConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: OpunclehConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: OpunclehConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: OpunclehConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: OpunclehConfig) => OpunclehConfig;
