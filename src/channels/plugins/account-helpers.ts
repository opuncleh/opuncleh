...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: OpunclehConfig): string | undefined {
  ...
  function listAccountIds(cfg: OpunclehConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: OpunclehConfig): string {
