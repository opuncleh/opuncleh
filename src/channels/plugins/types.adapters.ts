...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: OpunclehConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: OpunclehConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: OpunclehConfig) => string;
  setAccountEnabled?: (params: {
    cfg: OpunclehConfig;
    accountId: string;
    enabled: boolean;
  }) => OpunclehConfig;
  deleteAccount?: (params: { cfg: OpunclehConfig; accountId: string }) => OpunclehConfig;
  isEnabled?: (account: ResolvedAccount, cfg: OpunclehConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: OpunclehConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: OpunclehConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: OpunclehConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: OpunclehConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://www.opuncleh.com/docs.html/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: OpunclehConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: OpunclehConfig;
    nextCfg: OpunclehConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelExecApprovalAdapter = {
  ...
  hasConfiguredDmRoute?: (params: { cfg: OpunclehConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: OpunclehConfig; accountId?: string | null }) =>
    | {
