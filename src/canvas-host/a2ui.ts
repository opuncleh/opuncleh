...
export const A2UI_PATH = "/__opuncleh__/a2ui";

export const CANVAS_HOST_PATH = "/__opuncleh__/canvas";

export const CANVAS_WS_PATH = "/__opuncleh__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.opunclehCanvasA2UIAction.postMessage(...)
  // - Android: window.opunclehCanvasA2UIAction.postMessage(...)
  const handlerNames = ["opunclehCanvasA2UIAction"];
  ...
  globalThis.Opuncleh = globalThis.Opuncleh ?? {};
  globalThis.Opuncleh.postMessage = postToNode;
  globalThis.Opuncleh.sendUserAction = sendUserAction;
  globalThis.opunclehPostMessage = postToNode;
  globalThis.opunclehSendUserAction = sendUserAction;
