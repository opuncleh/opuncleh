  ...
  return {
    ...
    loadConfig: () => ({
      browser: {
        ...
        profiles: {
          opuncleh: { cdpPort: testPort + 1, color: "#FF4500" },
        },
      },
    }),
...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.OPUNCLEH_GATEWAY_PORT;
    process.env.OPUNCLEH_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.OPUNCLEH_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.OPUNCLEH_GATEWAY_PASSWORD;
