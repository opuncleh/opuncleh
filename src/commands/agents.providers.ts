...
function resolveDefaultAccountId(cfg: OpunclehConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpunclehConfig): boolean {
...
export function summarizeBindings(cfg: OpunclehConfig, bindings: AgentBinding[]): string[] {
