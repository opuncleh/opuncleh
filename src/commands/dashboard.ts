...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set OPUNCLEH_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `opuncleh dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Opuncleh.");
  } else if (hint) {
    runtime.log(hint);
  }
}
