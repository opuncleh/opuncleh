...
describe("detectMacCloudSyncedStateDir", () => {
  ...
  it("detects state dir under Library/CloudStorage", () => {
    const stateDir = path.join(home, "Library", "CloudStorage", "Dropbox", "Opuncleh", ".opuncleh");
  ...
  it("detects cloud-synced target when state dir resolves via symlink", () => {
    const symlinkPath = "/tmp/opuncleh-state";
  ...
  it("ignores cloud-synced symlink prefix when resolved target is local", () => {
    ...
    const resolvedLocalPath = path.join(home, ".opuncleh");
  ...
  it("anchors cloud detection to OS homedir when OPUNCLEH_HOME is overridden", () => {
    const stateDir = path.join(home, "Library", "CloudStorage", "iCloud Drive", ".opuncleh");
    const originalOpunclehHome = process.env.OPUNCLEH_HOME;
    process.env.OPUNCLEH_HOME = "/tmp/opuncleh-home-override";
