/**
 * Hook system for Opuncleh agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __opuncleh_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__opuncleh_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
