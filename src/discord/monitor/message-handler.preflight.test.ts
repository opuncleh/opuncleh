...
type DiscordConfig = NonNullable<
  import("../../config/config.js").OpunclehConfig["channels"]
>["discord"];
...
} as import("../../config/config.js").OpunclehConfig;
...
function createPreflightArgs(params: {
  cfg: import("../../config/config.js").OpunclehConfig;
