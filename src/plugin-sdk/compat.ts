...
const shouldWarnCompatImport =
  ...
  process.env.OPUNCLEH_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "opuncleh/plugin-sdk/compat is deprecated for new plugins. Migrate to focused opuncleh/plugin-sdk/<subpath> imports.",
    {
      code: "OPUNCLEH_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
