...
import * as coreSdk from "opuncleh/plugin-sdk/core";
import type {
  ChannelMessageActionContext as CoreChannelMessageActionContext,
  OpunclehPluginApi as CoreOpunclehPluginApi,
...
import * as lazyRuntimeSdk from "opuncleh/plugin-sdk/lazy-runtime";
import * as lineSdk from "opuncleh/plugin-sdk/line";
import * as msteamsSdk from "opuncleh/plugin-sdk/msteams";
import * as nostrSdk from "opuncleh/plugin-sdk/nostr";
import * as ollamaSetupSdk from "opuncleh/plugin-sdk/ollama-setup";
import * as providerSetupSdk from "opuncleh/plugin-sdk/provider-setup";
import * as routingSdk from "opuncleh/plugin-sdk/routing";
import * as runtimeSdk from "opuncleh/plugin-sdk/runtime";
import * as sandboxSdk from "opuncleh/plugin-sdk/sandbox";
import * as selfHostedProviderSetupSdk from "opuncleh/plugin-sdk/self-hosted-provider-setup";
import * as setupSdk from "opuncleh/plugin-sdk/setup";
...
const bundledExtensionSubpathLoaders = pluginSdkSubpaths.map((id: string) => ({
  id,
  load: () => importPluginSdkSubpath(`opuncleh/plugin-sdk/${id}`),
}));

const asExports = (mod: object) => mod as Record<string, unknown>;
const ircSdk = await import("opuncleh/plugin-sdk/irc");
const feishuSdk = await import("opuncleh/plugin-sdk/feishu");
const googlechatSdk = await import("opuncleh/plugin-sdk/googlechat");
const zaloSdk = await import("opuncleh/plugin-sdk/zalo");
const synologyChatSdk = await import("opuncleh/plugin-sdk/synology-chat");
const zalouserSdk = await import("opuncleh/plugin-sdk/zalouser");
const tlonSdk = await import("opuncleh/plugin-sdk/tlon");
const acpxSdk = await import("opuncleh/plugin-sdk/acpx");
const bluebubblesSdk = await import("opuncleh/plugin-sdk/bluebubbles");
const matrixSdk = await import("opuncleh/plugin-sdk/matrix");
const mattermostSdk = await import("opuncleh/plugin-sdk/mattermost");
const nextcloudTalkSdk = await import("opuncleh/plugin-sdk/nextcloud-talk");
const twitchSdk = await import("opuncleh/plugin-sdk/twitch");
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("exports shared core types used by bundled channels", () => {
    expectTypeOf<CoreOpunclehPluginApi>().toMatchTypeOf<OpunclehPluginApi>();
  ...
  it("keeps core shared types aligned with the channel prelude", () => {
    expectTypeOf<CoreOpunclehPluginApi>().toMatchTypeOf<SharedOpunclehPluginApi>();
