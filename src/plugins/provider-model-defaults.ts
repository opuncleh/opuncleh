...
export function applyOpenAIProviderConfig(cfg: OpunclehConfig): OpunclehConfig {
...
export function applyOpenAIConfig(cfg: OpunclehConfig): OpunclehConfig {
...
export function applyOpencodeZenModelDefault(cfg: OpunclehConfig): {
  next: OpunclehConfig;
  changed: boolean;
} {
