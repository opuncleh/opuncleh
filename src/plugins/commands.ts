...
type RegisteredPluginCommand = OpunclehPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
function listPluginInvocationKeys(command: OpunclehPluginCommandDefinition): string[] {
...
function listPluginInvocationNames(command: OpunclehPluginCommandDefinition): string[] {
