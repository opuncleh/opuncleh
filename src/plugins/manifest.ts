...
export const PLUGIN_MANIFEST_FILENAME = "opuncleh.plugin.json";
...
// package.json "opuncleh" metadata (used for setup/catalog)
...
export type OpunclehPackageStartup = {
  /**
...
export type OpunclehPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: OpunclehPackageStartup;
};
...
): OpunclehPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
