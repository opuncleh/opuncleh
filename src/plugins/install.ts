...
const MISSING_EXTENSIONS_ERROR =
  'package.json missing opuncleh.extensions; update the plugin package to include opuncleh.extensions (for example ["./dist/index.js"]). See https://docs.opuncleh.io/help/troubleshooting#plugin-install-fails-with-missing-opuncleh-extensions';
