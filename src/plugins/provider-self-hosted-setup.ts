...
export function applyProviderDefaultModel(cfg: OpunclehConfig, modelRef: string): OpunclehConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: OpunclehConfig; modelId: string; modelRef: string; profileId: string } {
