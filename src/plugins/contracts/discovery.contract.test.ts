...
vi.mock("opuncleh/plugin-sdk/provider-setup", async () => {
  const actual = await vi.importActual<object>("opuncleh/plugin-sdk/provider-setup");
  return {
    ...actual,
...
vi.mock("opuncleh/plugin-sdk/self-hosted-provider-setup", async () => {
  const actual = await vi.importActual<object>("opuncleh/plugin-sdk/self-hosted-provider-setup");
  return {
    ...actual,
    buildVllmProvider: (...args: unknown[]) => buildVllmProviderMock(...args),
    buildSglangProvider: (...args: unknown[]) => buildSglangProviderMock(...args),
...
vi.mock("opuncleh/plugin-sdk/ollama-setup", async () => {
  const actual = await vi.importActual<object>("opuncleh/plugin-sdk/ollama-setup");
  return {
    ...actual,
    buildOllamaProvider: (...args: unknown[]) => buildOllamaProviderMock(...args),
  };
