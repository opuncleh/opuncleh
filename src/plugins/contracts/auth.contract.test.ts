...
import type { OpunclehPluginApi, ProviderPlugin } from "../types.js";

type LoginOpenAICodexOAuth =
  (typeof import("opuncleh/plugin-sdk/provider-auth"))["loginOpenAICodexOAuth"];
...
type GithubCopilotLoginCommand =
  (typeof import("opuncleh/plugin-sdk/provider-auth"))["githubCopilotLoginCommand"];
...
vi.mock("opuncleh/plugin-sdk/provider-auth", async (importOriginal) => {
  const actual = await importOriginal<typeof import("opuncleh/plugin-sdk/provider-auth")>();
  return {
    ...actual,
...
function registerProviders(...plugins: Array<{ register(api: OpunclehPluginApi): void }>) {
