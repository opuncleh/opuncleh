...
function resolveAnthropicDefaultAuthMode(cfg: OpunclehConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OpunclehConfig): OpunclehConfig {
...
export function applyTalkApiKey(config: OpunclehConfig): OpunclehConfig {
...
export function applyTalkConfigNormalization(config: OpunclehConfig): OpunclehConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: OpunclehConfig): OpunclehConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OpunclehConfig): OpunclehConfig {
...
export function applyLoggingDefaults(cfg: OpunclehConfig): OpunclehConfig {
...
export function applyContextPruningDefaults(cfg: OpunclehConfig): OpunclehConfig {
...
export function applyCompactionDefaults(cfg: OpunclehConfig): OpunclehConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
