...
export const FIELD_HELP: Record<string, string> = {
  ...
  "wizard.lastRunVersion":
    "Opuncleh version recorded at the time of the most recent wizard run on this config. Use this when diagnosing behavior differences across version-to-version onboarding changes.",
  ...
  "talk.voiceAliases":
    'Use this legacy ElevenLabs voice alias map (for example {"Lobstr":"EXAVITQu4vr4xnSDxMaL"}) only during migration. Prefer talk.providers.elevenlabs.voiceAliases.',
  "talk.modelId":
  ...
  "browser.profiles.*.driver":
    'Per-profile browser driver mode: "opuncleh" (or legacy "clawd") or "extension" depending on connection/runtime strategy. Use the driver that matches your browser control stack to avoid protocol mismatches.',
