...
show_usage() {
    cat << EOF
clawlog - Opuncleh Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Opuncleh logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Opuncleh logs flow through the macOS unified log (subsystem: ai.opuncleh).
