...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']opuncleh\/plugin-sdk["']/,
    hint: "Use opuncleh/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']opuncleh\/plugin-sdk\/test-utils["']/,
    hint: "Use opuncleh/plugin-sdk/testing for the public extension test seam.",
  },
  {
    pattern: /["']opuncleh\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or opuncleh/plugin-sdk/testing for public seams.",
  },
  {
