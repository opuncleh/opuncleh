...
- OPUNCLEH_GATEWAY_VERSION = exact package.json version
- OPUNCLEH_MARKETING_VERSION = short iOS/App Store version
- OPUNCLEH_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
OPUNCLEH_GATEWAY_VERSION = ${PACKAGE_VERSION}
OPUNCLEH_MARKETING_VERSION = ${MARKETING_VERSION}
OPUNCLEH_BUILD_VERSION = ${BUILD_NUMBER}
EOF
