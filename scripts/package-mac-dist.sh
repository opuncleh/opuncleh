...
# Output:
# - dist/Opuncleh.app
# - dist/Opuncleh-<version>.zip
# - dist/Opuncleh-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.opuncleh.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Opuncleh.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Opuncleh-$VERSION.zip"
DMG="$ROOT_DIR/dist/Opuncleh-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Opuncleh-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Opuncleh-$VERSION.dSYM.zip"
