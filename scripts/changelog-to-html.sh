...
if [[ -z "$version_content" ]]; then
  echo "<h2>Opuncleh $VERSION</h2>"
  echo "<p>Latest Opuncleh update.</p>"
  echo "<p><a href=\"https://github.com/opuncleh/opuncleh/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
