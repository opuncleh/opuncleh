---
summary: "Use Kilo Gateway's unified API to access many models in Opuncleh"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in Opuncleh
---
...
```bash
opuncleh onboard --kilocode-api-key <key>
```
...
Opuncleh dynamically discovers available models from the Kilo Gateway at startup. Use
