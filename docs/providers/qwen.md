---
summary: "Use Qwen OAuth (free tier) in Opuncleh"
read_when:
  - You want to use Qwen with Opuncleh
...
If you already logged in with the Qwen Code CLI, Opuncleh will sync credentials
