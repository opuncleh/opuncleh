---
summary: "Use Qianfan's unified API to access many models in Opuncleh"
read_when:
...
3. Opuncleh installed on your system
...
4. Copy the API key for use with Opuncleh

## CLI setup

```bash
opuncleh onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Opuncleh Configuration](/gateway/configuration)
