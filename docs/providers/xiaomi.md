---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Opuncleh"
read_when:
  - You want Xiaomi MiMo models in Opuncleh
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Opuncleh uses
