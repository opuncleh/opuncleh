---
summary: "Use NVIDIA's OpenAI-compatible API in Opuncleh"
read_when:
  - You want to use NVIDIA models in Opuncleh
...
opuncleh onboard --auth-choice skip
opuncleh models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
