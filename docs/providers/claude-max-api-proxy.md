...
You can point Opuncleh at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Opuncleh
...
- [Anthropic provider](/providers/anthropic) - Native Opuncleh integration with Claude setup-token or API keys
