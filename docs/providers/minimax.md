...
```bash
opuncleh plugins enable minimax  # skip if already loaded.
...
See [MiniMax plugin README](https://github.com/opuncleh/opuncleh/tree/main/extensions/minimax) for details.
