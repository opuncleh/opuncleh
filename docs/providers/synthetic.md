---
summary: "Use Synthetic's Anthropic-compatible API in Opuncleh"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Opuncleh registers it as the
...
Note: Opuncleh's Anthropic client appends `/v1` to the base URL, so use
