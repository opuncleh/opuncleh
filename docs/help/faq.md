---
summary: "Frequently asked questions about Opuncleh setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up Opuncleh?](#whats-the-recommended-way-to-install-and-set-up-opuncleh)
  ...
  - [I can't access docs.opuncleh.com (SSL error). What now?](#i-cant-access-docsopunclehai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or opuncleh not recognized](#windows-install-says-git-not-found-or-opuncleh-not-recognized)
  ...
  - [How do I install Opuncleh on Linux?](#how-do-i-install-opuncleh-on-linux)
  - [How do I install Opuncleh on a VPS?](#how-do-i-install-opuncleh-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Opuncleh to update itself?](#can-i-ask-opuncleh-to-update-itself)
  ...
  - [If I buy a Mac mini to run Opuncleh, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-opuncleh-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Opuncleh instances?](#can-multiple-people-use-one-whatsapp-number-with-different-opuncleh-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Opuncleh on a dedicated machine?](#how-important-is-it-to-run-opuncleh-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Opuncleh in a VM and what are the requirements](#can-i-run-opuncleh-in-a-vm-and-what-are-the-requirements)
- [What is Opuncleh?](#what-is-opuncleh)
  - [What is Opuncleh, in one paragraph?](#what-is-opuncleh-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Opuncleh](#what-are-the-top-five-everyday-use-cases-for-opuncleh)
  - [Can Opuncleh help with lead gen outreach ads and blogs for a SaaS](#can-opuncleh-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Opuncleh run tasks on a schedule or continuously in the background?](#can-opuncleh-run-tasks-on-a-schedule-or-continuously-in-the-background)
  - [Can I run Apple macOS-only skills from Linux?](#can-i-run-apple-macos-only-skills-from-linux)
  - [Do you have a Notion or HeyGen integration?](#do-you-have-a-notion-or-heygen-integration)
  - [How do I use my existing signed-in Chrome with Opuncleh?](#how-do-i-use-my-existing-signed-in-chrome-with-opuncleh)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Opuncleh saved locally?](#is-all-data-used-with-opuncleh-saved-locally)
  - [Where does Opuncleh store its data?](#where-does-opuncleh-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Opuncleh?](#how-do-i-completely-uninstall-opuncleh)
...
- [Config basics](#config-basics)
  ...
  - [Can the Opuncleh browser run headless?](#can-the-opuncleh-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two Opuncleh instances talk to each other (local + VPS)?](#can-two-opuncleh-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Opuncleh load environment variables?](#how-does-opuncleh-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of Opuncleh instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-opuncleh-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Opuncleh but keep it installed?](#how-do-i-completely-reset-opuncleh-but-keep-it-installed)
  ...
  - [Why doesn't Opuncleh reply in a group?](#why-doesnt-opuncleh-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Opuncleh, Flawd, and Krill use for models?](#what-do-opuncleh-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `opuncleh gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-opuncleh-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `opuncleh gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-opuncleh-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Opuncleh in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-opuncleh-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Opuncleh?](#i-closed-my-terminal-on-windows-how-do-i-restart-opuncleh)
  ...
  - [ELI5: `opuncleh gateway restart` vs `opuncleh gateway`](#eli5-opuncleh-gateway-restart-vs-opuncleh-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Opuncleh to inbound DMs?](#is-it-safe-to-expose-opuncleh-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/opuncleh/opuncleh-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   opuncleh health --verbose   # shows the target URL + config path on errors
   ```
...
This installs Opuncleh **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/opuncleh/opuncleh/issues](https://github.com/opuncleh/opuncleh/issues)
[https://github.com/opuncleh/opuncleh/pulls](https://github.com/opuncleh/opuncleh/pulls)

Start with these commands (share outputs when asking for help):

```bash
opuncleh status
opuncleh models status
opuncleh doctor
```

What they do:

- `opuncleh status`: quick snapshot of gateway/agent health + basic config.
- `opuncleh models status`: checks provider auth + model availability.
- `opuncleh doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `opuncleh status --all`, `opuncleh logs --follow`,
`opuncleh gateway status`, `opuncleh health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up Opuncleh
...
If you don't have a global install yet, run it via `pnpm opuncleh onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `OPUNCLEH_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `opuncleh config get gateway.auth.token` (or generate one: `opuncleh doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `opuncleh gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `opuncleh gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install Opuncleh on the new machine.
2. Copy `$OPUNCLEH_STATE_DIR` (default: `~/.opuncleh`) from the old machine.
3. Copy your workspace (default: `~/.opuncleh/workspace`).
4. Run `opuncleh doctor` and restart the Gateway service.
...
under `~/.opuncleh/` (for example `~/.opuncleh/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-opuncleh-store-its-data),
...
[https://github.com/opuncleh/opuncleh/blob/main/CHANGELOG.md](https://github.com/opuncleh/opuncleh/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I can't access docs.opuncleh.com SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.opuncleh.com` via Xfinity
Advanced Security. Disable it or allowlist `docs.opuncleh.com`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsopunclehai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/opuncleh/opuncleh/tree/main/docs](https://github.com/opuncleh/opuncleh/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://opuncleh.com/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://opuncleh.com/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://opuncleh.com/install.ps1](https://opuncleh.com/install.ps1)
...
```bash
curl -fsSL https://opuncleh.com/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://opuncleh.com/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://opuncleh.com/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://opuncleh.com/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or opuncleh not recognized
...
**2) opuncleh is not recognized after install**
...
If you still reproduce this on latest Opuncleh, track/report it in:

- [Issue #30640](https://github.com/opuncleh/opuncleh/issues/30640)
...
### How do I install Opuncleh on Linux
...
### How do I install Opuncleh on a VPS
...
### Can I ask Opuncleh to update itself
...
```bash
opuncleh update
opuncleh update status
opuncleh update --channel stable|beta|dev
opuncleh update --tag <dist-tag|version>
opuncleh update --no-restart
```

If you must automate from an agent:

```bash
opuncleh update --yes --no-restart
opuncleh gateway restart
```
...
`opuncleh onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Opuncleh with **API keys** (Anthropic/OpenAI/others) or with
...
OpenAI Codex OAuth is explicitly supported for external tools like Opuncleh.
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in onboarding or paste it with `opuncleh models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in onboarding. If you want to run it on the gateway host, use `opuncleh models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `opuncleh models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. Opuncleh no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Opuncleh can keep replying while a provider is rate-limited.
...
Opuncleh supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). Onboarding can run the OAuth flow and will set the default model to `openai-codex/gpt-5.4` when appropriate. See [Model providers](/concepts/model-providers) and [Onboarding (CLI)](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Opuncleh fully supports **OpenAI Code (Codex) subscription OAuth**.
OpenAI explicitly allows subscription OAuth usage in external tools/workflows
like Opuncleh. Onboarding can run the OAuth flow for you.

See [OAuth](/concepts/oauth), [Model providers](/concepts/model-providers), and [Onboarding (CLI)](/start/wizard).

### How do I set up Gemini CLI OAuth

Gemini CLI uses a **plugin auth flow**, not a client id or secret in `opuncleh.json`.

Steps:

1. Enable the plugin: `opuncleh plugins enable google`
2. Login: `opuncleh models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Opuncleh needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.5 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Opuncleh runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run Opuncleh can I connect it to my MacBook Pro
...
- Use `opuncleh nodes status` / `opuncleh nodes list` to see it.
...
Onboarding accepts `@username` input and resolves it to a numeric ID, but Opuncleh authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `opuncleh logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Opuncleh instances
...
If you run Opuncleh via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the Opuncleh code install. Your state
(`~/.opuncleh`) and workspace (`~/.opuncleh/workspace`) stay untouched.
...
**Opuncleh-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Opuncleh on a dedicated machine
...
Opuncleh is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Opuncleh in a VM and what are the requirements
...
### What is Opuncleh in one paragraph

Opuncleh is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

Opuncleh is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Opuncleh
...
### Can Opuncleh help with lead gen outreach ads and blogs for a SaaS
...
Opuncleh draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Opuncleh is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Opuncleh when you
...
Showcase: [https://opuncleh.com/showcase](https://opuncleh.com/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.opuncleh/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.opuncleh/opuncleh.json`). Precedence is `<workspace>/skills` > `~/.opuncleh/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.opuncleh/opuncleh.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.opuncleh/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which Opuncleh treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `OPUNCLEH_SKIP_CRON` is not set.
...
```bash
opuncleh cron run <jobId> --force
opuncleh cron runs --id <jobId> --limit 50
```
...
### Can Opuncleh run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.opuncleh.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-opuncleh-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Opuncleh can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.opuncleh/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "opuncleh": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured Opuncleh workspace); Opuncleh treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.opuncleh/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).

### How do I use my existing signed-in Chrome with Opuncleh
...
opuncleh browser --browser-profile user snapshot
```
...
- Persist `/home/node` with `OPUNCLEH_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `OPUNCLEH_DOCKER_APT_PACKAGES`.
...
Opuncleh memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Opuncleh also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, Opuncleh auto-selects a provider when it
...
configured and present, Opuncleh
...
### Is all data used with Opuncleh saved locally

No - **Opuncleh's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.opuncleh` + your workspace directory).
...
### Where does Opuncleh store its data

Everything lives under `$OPUNCLEH_STATE_DIR` (default: `~/.opuncleh`):

| Path                                                            | Purpose                                                            |
| --------------------------------------------------------------- | ------------------------------------------------------------------ |
| `$OPUNCLEH_STATE_DIR/opuncleh.json`                             | Main config (JSON5)                                                |
| `$OPUNCLEH_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use)       |
| `$OPUNCLEH_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth, API keys, and optional `keyRef`/`tokenRef`)  |
| `$OPUNCLEH_STATE_DIR/secrets.json`                              | Optional file-backed secret payload for `file` SecretRef providers |
| `$OPUNCLEH_STATE_DIR/agents/<agentId>/agent/auth.json`          | Legacy compatibility file (static `api_key` entries scrubbed)      |
| `$OPUNCLEH_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)            |
| `$OPUNCLEH_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                              |
| `$OPUNCLEH_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                           |
| `$OPUNCLEH_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                       |

Legacy single-agent path: `~/.opuncleh/agent/*` (migrated by `opuncleh doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.opuncleh/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.opuncleh`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or legacy fallback `memory.md` when `MEMORY.md` is absent),
  `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.opuncleh`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.opuncleh/skills`).

Default workspace is `~/.opuncleh/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.opuncleh/workspace" } },
}
```
...
Do **not** commit anything under `~/.opuncleh` (credentials, sessions, tokens, or encrypted secrets payloads).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Opuncleh
...
`workspace` to the repo root. The Opuncleh repo is just source code; keep the
...
Opuncleh reads an optional **JSON5** config from `$OPUNCLEH_CONFIG_PATH` (default: `~/.opuncleh/opuncleh.json`):

```
$OPUNCLEH_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.opuncleh/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `OPUNCLEH_GATEWAY_TOKEN`).
...
Opuncleh enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `opuncleh doctor --generate-gateway-token`.
...
- `default`: uses `All your chats, one Opuncleh.` every time.
- `random`: rotating funny/seasonal taglines (default behavior).
- If you want no banner at all, set env `OPUNCLEH_HIDE_BANNER=1`.
...
**Recommended:** run `opuncleh configure --section web` and choose a provider.
...
- Daemons read env vars from `~/.opuncleh/.env` (or the service environment).
...
### Can the Opuncleh browser run headless
...
- Gateway is running: `opuncleh gateway status`
- Gateway health: `opuncleh status`
- Channel health: `opuncleh channels status`
...
### Can two Opuncleh instances talk to each other local VPS
...
`opuncleh agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
opuncleh agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.opuncleh/opuncleh.json`).
- If you have no backup, re-run `opuncleh doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `opuncleh config set` for small changes.
- Use `opuncleh configure` for interactive edits.
...
```bash
opuncleh gateway --tailscale serve
```
...
### How does Opuncleh load environment variables

Opuncleh reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.opuncleh/.env` (aka `$OPUNCLEH_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.opuncleh/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`OPUNCLEH_LOAD_SHELL_ENV=1`, `OPUNCLEH_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`opuncleh models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means Opuncleh won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.opuncleh/.env`:
...
### Is there a way to make a team of Opuncleh instances one CEO and many agents
...
### How do I completely reset Opuncleh but keep it installed
...
```bash
opuncleh reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `OPUNCLEH_PROFILE`), reset each state dir (defaults are `~/.opuncleh-<profile>`).
- Dev reset: `opuncleh gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Opuncleh skips the heartbeat run to save API calls.
...
No. Opuncleh runs on **your own account**, so if you're in the group, Opuncleh can see it.
...
```bash
opuncleh directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesn't Opuncleh reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.opuncleh/agents/<agentId>/sessions/`.
...
- Use `opuncleh doctor` to spot stray workspaces and profile mismatches.
...
Opuncleh's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, Opuncleh currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
4. Run `opuncleh onboard` and choose `Ollama`
...
- for manual switching, use `opuncleh models list` and `opuncleh models set ollama/<model>`
...
- `opuncleh models set ...` (updates just model config)
- `opuncleh configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.opuncleh/opuncleh.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `opuncleh doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do Opuncleh, Flawd, and Krill use for models

- These deployments can differ and may change over time; there is no fixed provider recommendation.
- Check the current runtime setting on each gateway with `opuncleh models status`.
...
Yes. Opuncleh ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.opuncleh/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `opuncleh agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Opuncleh can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.opuncleh/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.opuncleh/agent/*` (migrated by `opuncleh doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.opuncleh/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `opuncleh models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `opuncleh models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `opuncleh models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.opuncleh/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    opuncleh models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Opuncleh will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: Opuncleh now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Opuncleh uses provider-prefixed IDs like:
...
Opuncleh may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `opuncleh models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
opuncleh models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
opuncleh models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
opuncleh models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
opuncleh models auth order set --provider anthropic --agent main anthropic:default
```
...
```
--port > OPUNCLEH_GATEWAY_PORT > gateway.port > default 18789
```

### Why does opuncleh gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `opuncleh gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does opuncleh gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `OPUNCLEH_STATE_DIR` mismatch).

Fix:

```bash
opuncleh gateway install --force
```
...
Opuncleh enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `opuncleh gateway --port <port>`.

### How do I run Opuncleh in remote mode client connects to a Gateway elsewhere
...
- `opuncleh gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- Fastest: `opuncleh dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `opuncleh doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `OPUNCLEH_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- If mismatch persists after the one retry, rotate/re-approve the paired device token:
  - `opuncleh devices list`
  - `opuncleh devices rotate --device <id> --role operator`
- Still stuck? Run `opuncleh status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `OPUNCLEH_CONFIG_PATH` (per-instance config)
- `OPUNCLEH_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `opuncleh --profile <name> …` per instance (auto-creates `~/.opuncleh-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `opuncleh --profile <name> gateway install`.

Profiles also suffix service names (`ai.opuncleh.<profile>`; legacy `com.opuncleh.*`, `opuncleh-gateway-<profile>.service`, `Opuncleh Gateway (<profile>)`).
...
```
opuncleh tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/opuncleh/opuncleh-YYYY-MM-DD.log
```
...
- macOS: `$OPUNCLEH_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.opuncleh/logs/...`; profiles use `~/.opuncleh-<profile>/logs/...`)
- Linux: `journalctl --user -u opuncleh-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "Opuncleh Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `opuncleh gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Opuncleh
...
1. Is the Gateway running? `opuncleh gateway status`
2. Is the Gateway healthy? `opuncleh status`
3. Does the UI have the right token? `opuncleh dashboard`
...
```bash
opuncleh channels status
opuncleh channels logs --channel telegram
```

Then match the error:

- `BOT_COMMANDS_TOO_MUCH`: the Telegram menu has too many entries. Opuncleh already trims to the Telegram limit and retries with fewer commands, but some menu entries still need to be dropped. Reduce plugin/skill/custom commands, or disable `channels.telegram.commands.native` if you do not need the menu.
...
```bash
opuncleh gateway stop
opuncleh gateway start
```
...
### ELI5 opuncleh gateway restart vs opuncleh gateway

- `opuncleh gateway restart`: restarts the **background service** (launchd/systemd).
- `opuncleh gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `opuncleh gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Opuncleh assistant setup](/start/opuncleh) and [Agent send](/tools/agent-send).

CLI sending:

```bash
opuncleh message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Opuncleh to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `opuncleh pairing approve --channel <channel> [--account <id>] <code>`
  - Pending requests are capped at **3 per channel**; check `opuncleh pairing list --channel <channel> [--account <id>]` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `opuncleh doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Opuncleh only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
opuncleh pairing approve whatsapp <code>
```

List pending requests:

```bash
opuncleh pairing list whatsapp
```
...
Opuncleh blocks **cross-provider** messaging by default. If a tool call is bound
