...
read_when:
  ...
  - Reviewing Opuncleh security posture
title: "Pairing"
---

# Pairing

“Pairing” is Opuncleh’s explicit **owner approval** step.
...
Stored under `~/.opuncleh/credentials/`:
...
3. On your phone, open the Opuncleh iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `opuncleh nodes pending/approve`) is a
