...
- Install via CLI: `opuncleh plugins install @opuncleh/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `opuncleh plugins install ./extensions/zalo`
   - From npm (if published): `opuncleh plugins install @opuncleh/zalo`
...
This page reflects current Opuncleh behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `opuncleh pairing list zalo`
  - `opuncleh pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Opuncleh.
...
- Example: `opuncleh message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `opuncleh channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `opuncleh logs --follow`
