...
Opuncleh can convert outbound replies into audio using ElevenLabs, Microsoft, or OpenAI.
...
Opuncleh defaults to Microsoft (unless disabled via
...
- **Microsoft**: uses `microsoft.outputFormat` (default `audio-24khz-48kbitrate-mono-mp3`).
  ...
  - If the configured Microsoft output format fails, Opuncleh retries with MP3.
