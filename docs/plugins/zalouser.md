...
read_when:
  - You want Zalo Personal (unofficial) support in Opuncleh
...
Zalo Personal support for Opuncleh via a plugin, using native `zca-js` to automate a normal Zalo user account.
