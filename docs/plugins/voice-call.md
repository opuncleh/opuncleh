...
read_when:
  - You want to place an outbound voice call from Opuncleh
...
Voice calls for Opuncleh via a plugin. Supports outbound notifications and
...
- Use `opuncleh voicecall ...` or the `voice_call` tool
...
```bash
opuncleh plugins install ./extensions/voice-call
