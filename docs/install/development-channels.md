...
Opuncleh ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Opuncleh also aligns
the install method:
...
When you switch channels with `opuncleh update`, Opuncleh also syncs plugin sources:
