...
CLI onboarding is the **recommended** way to set up Opuncleh on macOS,
...
If the config is invalid or contains legacy keys, onboarding asks you to run `opuncleh doctor` first.
</Note>
