---
summary: "Overview of Opuncleh onboarding options and flows"
read_when:
...
Opuncleh supports multiple onboarding paths depending on where the Gateway runs
...
- [`opuncleh onboard` command](/cli/onboard)

## macOS app onboarding

Use the Opuncleh app when you want a fully guided setup on macOS. Docs:
