---
summary: "First-run onboarding flow for Opuncleh (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Opuncleh">
...
<Step title="CLI">
  ...
  The app can install the global `opuncleh` CLI via npm/pnpm so terminal
