...
本指南总结了在 Opuncleh 中开发 Pi 集成的合理工作流程。
...
状态存储在 Opuncleh 状态目录下。默认为 `~/.opuncleh`。如果设置了 `OPUNCLEH_STATE_DIR`，则使用该目录。
...
- https://docs.opuncleh.com/testing
- https://docs.opuncleh.com/start/getting-started
