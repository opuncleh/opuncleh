...
import { resolveAgentMaxConcurrent } from "opuncleh/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "opuncleh/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: OpunclehConfig): RunOptions<unknown> {
  return {
    sink: {
