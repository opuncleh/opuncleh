...
import type { OpunclehConfig } from "../../../src/config/config.js";
...
type ResolveConfiguredBindingRouteFn =
  typeof import("opuncleh/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("opuncleh/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
vi.mock("opuncleh/plugin-sdk/channel-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("opuncleh/plugin-sdk/channel-runtime")>();
  return {
    ...actual,
...
describe("registerTelegramNativeCommands — session metadata", () => {
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/opuncleh-sessions.json");
