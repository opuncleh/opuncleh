...
import { createFinalizableDraftLifecycle } from "opuncleh/plugin-sdk/channel-runtime";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("opuncleh.telegramDraftStreamState");
