import { resolveAccountWithDefaultFallback } from "opuncleh/plugin-sdk/account-resolution";
...
import { tryReadSecretFileSync } from "opuncleh/plugin-sdk/infra-runtime";
import { resolveDefaultSecretProviderAlias } from "opuncleh/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "opuncleh/plugin-sdk/routing";
import type { TelegramAccountConfig } from "opuncleh/plugin-sdk/telegram";
import {
...
function inspectTokenValue(params: { cfg: OpunclehConfig; value: unknown }): {
  token: string;
