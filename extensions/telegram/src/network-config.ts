...
import type { TelegramNetworkConfig } from "opuncleh/plugin-sdk/config-runtime";
import { isTruthyEnvValue } from "opuncleh/plugin-sdk/infra-runtime";
import { isWSL2Sync } from "opuncleh/plugin-sdk/infra-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "OPUNCLEH_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "OPUNCLEH_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "OPUNCLEH_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable OPUNCLEH_TELEGRAM_DNS_RESULT_ORDER
