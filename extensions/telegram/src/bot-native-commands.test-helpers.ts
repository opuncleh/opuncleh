...
import type { TelegramAccountConfig } from "opuncleh/plugin-sdk/config-runtime";
...
type GetPluginCommandSpecsFn =
  typeof import("opuncleh/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("opuncleh/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("opuncleh/plugin-sdk/plugin-runtime").executePluginCommand;
type DispatchReplyWithBufferedBlockDispatcherFn =
  typeof import("opuncleh/plugin-sdk/reply-runtime").dispatchReplyWithBufferedBlockDispatcher;
type DispatchReplyWithBufferedBlockDispatcherResult = Awaited<
  ReturnType<DispatchReplyWithBufferedBlockDispatcherFn>
>;
type RecordInboundSessionMetaSafeFn =
  typeof import("opuncleh/plugin-sdk/channel-runtime").recordInboundSessionMetaSafe;
...
vi.mock("opuncleh/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("opuncleh/plugin-sdk/reply-runtime", () => ({
...
vi.mock("opuncleh/plugin-sdk/channel-runtime", () => ({
...
vi.mock("opuncleh/plugin-sdk/conversation-runtime", () => ({
...
export function createNativeCommandsHarness(params?: {
  ...
  registerTelegramNativeCommands({
    bot,
    cfg: params?.cfg ?? ({} as OpunclehConfig),
