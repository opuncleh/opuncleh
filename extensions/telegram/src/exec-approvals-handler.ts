...
import { resolveExecApprovalSessionTarget } from "opuncleh/plugin-sdk/infra-runtime";
import type { ExecApprovalRequest, ExecApprovalResolved } from "opuncleh/plugin-sdk/infra-runtime";
import { normalizeAccountId, parseAgentSessionKey } from "opuncleh/plugin-sdk/routing";
...
function isHandlerConfigured(params: { cfg: OpunclehConfig; accountId: string }): boolean {
  const config = resolveTelegramExecApprovalConfig({
    cfg: params.cfg,
    accountId: params.accountId,
  });
