...
import type { ChannelSetupAdapter, ChannelSetupDmPolicy } from "opuncleh/plugin-sdk/setup";
...
export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("opuncleh logs --follow")}\` (safest)`,
