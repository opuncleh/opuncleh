...
import {
  ...
  loadModelCatalog,
  modelSupportsVision,
} from "opuncleh/plugin-sdk/agent-runtime";
import { resolveDefaultModelForAgent } from "opuncleh/plugin-sdk/agent-runtime";
import { removeAckReactionAfterReply } from "opuncleh/plugin-sdk/channel-runtime";
import { logAckFailure, logTypingFailure } from "opuncleh/plugin-sdk/channel-runtime";
...
import { clearHistoryEntriesIfEnabled } from "opuncleh/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: OpunclehConfig, agentId: string) {
  try {
