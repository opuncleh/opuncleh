import { buildAccountScopedAllowlistConfigEditor } from "opuncleh/plugin-sdk/allowlist-config-edit";
import {
  collectAllowlistProviderGroupPolicyWarnings,
  collectOpenGroupPolicyRouteAllowlistWarnings,
  createScopedDmSecurityResolver,
} from "opuncleh/plugin-sdk/channel-config-helpers";
import { type OutboundSendDeps, resolveOutboundSendDep } from "opuncleh/plugin-sdk/channel-runtime";
import { normalizeMessageChannel } from "opuncleh/plugin-sdk/channel-runtime";
import { buildOutboundBaseSessionKey, normalizeOutboundThreadId } from "opuncleh/plugin-sdk/core";
import { resolveExecApprovalCommandDisplay } from "opuncleh/plugin-sdk/infra-runtime";
import { buildExecApprovalPendingReplyPayload } from "opuncleh/plugin-sdk/infra-runtime";
import { resolveThreadSessionKeys, type RoutePeer } from "opuncleh/plugin-sdk/routing";
import { parseTelegramTopicConversation } from "opuncleh/plugin-sdk/telegram";
import {
  ...
  type OpunclehConfig,
} from "opuncleh/plugin-sdk/telegram";
import {
...
function hasTelegramExecApprovalDmRoute(cfg: OpunclehConfig): boolean {
...
export const telegramPlugin: ChannelPlugin<ResolvedTelegramAccount, TelegramProbe> = {
  ...
  gateway: {
    ...
    logoutAccount: async ({ accountId, cfg }) => {
      ...
      const nextCfg = { ...cfg } as OpunclehConfig;
