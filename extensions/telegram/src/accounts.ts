...
import {
  ...
  type OpunclehConfig,
} from "opuncleh/plugin-sdk/account-resolution";
import { isTruthyEnvValue } from "opuncleh/plugin-sdk/infra-runtime";
import {
  listBoundAccountIds,
  resolveDefaultAgentBoundAccountId,
} from "opuncleh/plugin-sdk/routing";
import { formatSetExplicitDefaultInstruction } from "opuncleh/plugin-sdk/routing";
import { createSubsystemLogger } from "opuncleh/plugin-sdk/runtime-env";
import type { TelegramAccountConfig, TelegramActionConfig } from "opuncleh/plugin-sdk/telegram";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.OPUNCLEH_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: OpunclehConfig): string[] {
...
export function listTelegramAccountIds(cfg: OpunclehConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: OpunclehConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/opuncleh/opuncleh/issues/30673
...
export function listEnabledTelegramAccounts(cfg: OpunclehConfig): ResolvedTelegramAccount[] {
