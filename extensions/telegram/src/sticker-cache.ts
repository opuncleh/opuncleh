...
import { resolveApiKeyForProvider } from "opuncleh/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "opuncleh/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
...
import { loadJsonFile, saveJsonFile } from "opuncleh/plugin-sdk/json-store";
import { AUTO_IMAGE_KEY_PROVIDERS, DEFAULT_IMAGE_MODELS } from "opuncleh/plugin-sdk/media-runtime";
import { resolveAutoImageModel } from "opuncleh/plugin-sdk/media-runtime";
import { describeImageFileWithModel } from "opuncleh/plugin-sdk/media-understanding-runtime";
import { logVerbose } from "opuncleh/plugin-sdk/runtime-env";
import { STATE_DIR } from "opuncleh/plugin-sdk/state-paths";
