...
import { recordInboundSessionMetaSafe } from "opuncleh/plugin-sdk/channel-runtime";
import type { OpunclehConfig } from "opuncleh/plugin-sdk/config-runtime";
import type { ChannelGroupPolicy } from "opuncleh/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "opuncleh/plugin-sdk/config-runtime";
import {
  normalizeTelegramCommandName,
  resolveTelegramCustomCommands,
  TELEGRAM_COMMAND_NAME_PATTERN,
} from "opuncleh/plugin-sdk/config-runtime";
import type {
  ReplyToMode,
...
import { ensureConfiguredBindingRouteReady } from "opuncleh/plugin-sdk/conversation-runtime";
import { getAgentScopedMediaLocalRoots } from "opuncleh/plugin-sdk/media-runtime";
import {
  executePluginCommand,
  getPluginCommandSpecs,
  matchPluginCommand,
} from "opuncleh/plugin-sdk/plugin-runtime";
import { resolveChunkMode } from "opuncleh/plugin-sdk/reply-runtime";
import { resolveCommandAuthorization } from "opuncleh/plugin-sdk/reply-runtime";
import type { CommandArgs } from "opuncleh/plugin-sdk/reply-runtime";
import {
...
import { listSkillCommandsForAgents } from "opuncleh/plugin-sdk/reply-runtime";
...
import { danger, logVerbose } from "opuncleh/plugin-sdk/runtime-env";
import { getChildLogger } from "opuncleh/plugin-sdk/runtime-env";
import type { RuntimeEnv } from "opuncleh/plugin-sdk/runtime-env";
