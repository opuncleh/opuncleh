import type { OpunclehConfig, OpunclehPluginApi } from "opuncleh/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: OpunclehConfig): { id: string; name: string } {
