...
import { resolveAgentDir } from "opuncleh/plugin-sdk/agent-runtime";
import { agentCommandFromIngress } from "opuncleh/plugin-sdk/agent-runtime";
import { resolveTtsConfig, type ResolvedTtsConfig } from "opuncleh/plugin-sdk/agent-runtime";
...
import type { DiscordAccountConfig, TtsConfig } from "opuncleh/plugin-sdk/config-runtime";
import { formatErrorMessage } from "opuncleh/plugin-sdk/infra-runtime";
import { resolvePreferredOpunclehTmpDir } from "opuncleh/plugin-sdk/infra-runtime";
import { transcribeAudioFile } from "opuncleh/plugin-sdk/media-understanding-runtime";
...
import { parseTtsDirectives } from "opuncleh/plugin-sdk/speech";
import { textToSpeech } from "opuncleh/plugin-sdk/speech-runtime";
...
function resolveVoiceTtsConfig(params: { cfg: OpunclehConfig; override?: TtsConfig }): {
  cfg: OpunclehConfig;
...
async function writeWavFile(pcm: Buffer): Promise<{ path: string; durationSeconds: number }> {
  const tempDir = await fs.mkdtemp(path.join(resolvePreferredOpunclehTmpDir(), "discord-voice-"));
