...
import { normalizeMessageChannel } from "opuncleh/plugin-sdk/channel-runtime";
...
import type { DiscordExecApprovalConfig } from "opuncleh/plugin-sdk/config-runtime";
import { GatewayClient } from "opuncleh/plugin-sdk/gateway-runtime";
import { createOperatorApprovalsGatewayClient } from "opuncleh/plugin-sdk/gateway-runtime";
import type { EventFrame } from "opuncleh/plugin-sdk/gateway-runtime";
import { resolveExecApprovalCommandDisplay } from "opuncleh/plugin-sdk/infra-runtime";
import { getExecApprovalApproverDmNoticeText } from "opuncleh/plugin-sdk/infra-runtime";
import type {
  ExecApprovalDecision,
  ExecApprovalRequest,
  ExecApprovalResolved,
} from "opuncleh/plugin-sdk/infra-runtime";
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "opuncleh/plugin-sdk/routing";
import type { RuntimeEnv } from "opuncleh/plugin-sdk/runtime-env";
import { compileSafeRegex, testRegexWithBoundedInput } from "opuncleh/plugin-sdk/security-runtime";
