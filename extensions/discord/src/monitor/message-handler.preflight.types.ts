...
import type { SessionBindingRecord } from "opuncleh/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "opuncleh/plugin-sdk/reply-runtime";
import type { resolveAgentRoute } from "opuncleh/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("opuncleh/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("opuncleh/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("opuncleh/plugin-sdk/config-runtime").OpunclehConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
