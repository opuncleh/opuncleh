...
import { createArmableStallWatchdog } from "opuncleh/plugin-sdk/channel-runtime";
import { createConnectedChannelStatusPatch } from "opuncleh/plugin-sdk/gateway-runtime";
import { danger } from "opuncleh/plugin-sdk/runtime-env";
...
export async function runDiscordGatewayLifecycle(params: {
  ...
  try {
    ...
    // Carbon starts the gateway during client construction, before Opuncleh can
