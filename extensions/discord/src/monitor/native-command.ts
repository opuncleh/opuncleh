...
import { resolveNativeCommandSessionTargets } from "opuncleh/plugin-sdk/channel-runtime";
import { createReplyPrefixOptions } from "opuncleh/plugin-sdk/channel-runtime";
import type { OpunclehConfig, loadConfig } from "opuncleh/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "opuncleh/plugin-sdk/config-runtime";
import { resolveOpenProviderRuntimeGroupPolicy } from "opuncleh/plugin-sdk/config-runtime";
import { loadSessionStore, resolveStorePath } from "opuncleh/plugin-sdk/config-runtime";
import {
  ensureConfiguredBindingRouteReady,
  resolveConfiguredBindingRoute,
} from "opuncleh/plugin-sdk/conversation-runtime";
import { buildPairingReply } from "opuncleh/plugin-sdk/conversation-runtime";
import { getAgentScopedMediaLocalRoots } from "opuncleh/plugin-sdk/media-runtime";
import { executePluginCommand, matchPluginCommand } from "opuncleh/plugin-sdk/plugin-runtime";
...
import { resolveStoredModelOverride } from "opuncleh/plugin-sdk/reply-runtime";
import { dispatchReplyWithDispatcher } from "opuncleh/plugin-sdk/reply-runtime";
import type { ReplyPayload } from "opuncleh/plugin-sdk/reply-runtime";
import type { ResolvedAgentRoute } from "opuncleh/plugin-sdk/routing";
import { logVerbose } from "opuncleh/plugin-sdk/runtime-env";
import { createSubsystemLogger } from "opuncleh/plugin-sdk/runtime-env";
import { chunkItems } from "opuncleh/plugin-sdk/text-runtime";
import { withTimeout } from "opuncleh/plugin-sdk/text-runtime";
import { loadWebMedia } from "opuncleh/plugin-sdk/web-media";
...
type DiscordConfig = NonNullable<OpunclehConfig["channels"]>["discord"];
