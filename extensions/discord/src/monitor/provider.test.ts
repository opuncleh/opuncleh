...
vi.mock("opuncleh/plugin-sdk/plugin-runtime", async () => {
  const actual = await vi.importActual<typeof import("opuncleh/plugin-sdk/plugin-runtime")>(
    "opuncleh/plugin-sdk/plugin-runtime",
  );
  return {
    ...actual,
