...
import { formatDurationSeconds } from "opuncleh/plugin-sdk/infra-runtime";
...
type LoadedConfig = ReturnType<typeof import("opuncleh/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("opuncleh/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("opuncleh/plugin-sdk/runtime-env").createSubsystemLogger>;
