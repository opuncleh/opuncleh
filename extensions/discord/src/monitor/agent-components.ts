...
import { resolveHumanDelayConfig } from "opuncleh/plugin-sdk/agent-runtime";
import { resolveCommandAuthorizedFromAuthorizers } from "opuncleh/plugin-sdk/channel-runtime";
import { createReplyPrefixOptions } from "opuncleh/plugin-sdk/channel-runtime";
import { recordInboundSession } from "opuncleh/plugin-sdk/channel-runtime";
import type { OpunclehConfig } from "opuncleh/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "opuncleh/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "opuncleh/plugin-sdk/config-runtime";
import { readSessionUpdatedAt, resolveStorePath } from "opuncleh/plugin-sdk/config-runtime";
import type { DiscordAccountConfig } from "opuncleh/plugin-sdk/config-runtime";
import { issuePairingChallenge } from "opuncleh/plugin-sdk/conversation-runtime";
import { upsertChannelPairingRequest } from "opuncleh/plugin-sdk/conversation-runtime";
import {
  buildPluginBindingResolvedText,
  parsePluginBindingApprovalCustomId,
  resolvePluginConversationBindingApproval,
} from "opuncleh/plugin-sdk/conversation-runtime";
import { enqueueSystemEvent } from "opuncleh/plugin-sdk/infra-runtime";
import { getAgentScopedMediaLocalRoots } from "opuncleh/plugin-sdk/media-runtime";
import { dispatchPluginInteractiveHandler } from "opuncleh/plugin-sdk/plugin-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "opuncleh/plugin-sdk/reply-runtime";
import {
  formatInboundEnvelope,
  resolveEnvelopeFormatOptions,
} from "opuncleh/plugin-sdk/reply-runtime";
import { finalizeInboundContext } from "opuncleh/plugin-sdk/reply-runtime";
import { dispatchReplyWithBufferedBlockDispatcher } from "opuncleh/plugin-sdk/reply-runtime";
import { createReplyReferencePlanner } from "opuncleh/plugin-sdk/reply-runtime";
import { resolveAgentRoute } from "opuncleh/plugin-sdk/routing";
import { logVerbose } from "opuncleh/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "opuncleh/plugin-sdk/runtime-env";
import {
  readStoreAllowFromForDmPolicy,
  resolvePinnedMainDmOwnerFromAllowlist,
} from "opuncleh/plugin-sdk/security-runtime";
import { logDebug, logError } from "opuncleh/plugin-sdk/text-runtime";
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__opuncleh_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__opuncleh_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__opuncleh_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__opuncleh_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__opuncleh_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__opuncleh_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "Opuncleh form";
  customId = "__opuncleh_discord_component_modal_wildcard__";
  components = [];
