...
import type { DiscordAccountConfig, DiscordActionConfig } from "opuncleh/plugin-sdk/discord";
...
export function listEnabledDiscordAccounts(cfg: OpunclehConfig): ResolvedDiscordAccount[] {
