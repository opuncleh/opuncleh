...
} from "opuncleh/plugin-sdk/allowlist-config-edit";
import {
  buildAccountScopedDmSecurityPolicy,
  collectOpenGroupPolicyConfiguredRouteWarnings,
  collectOpenProviderGroupPolicyWarnings,
} from "opuncleh/plugin-sdk/channel-config-helpers";
import { resolveOutboundSendDep } from "opuncleh/plugin-sdk/channel-runtime";
...
import {
  ...
  type ChannelPlugin,
  type OpunclehConfig,
} from "opuncleh/plugin-sdk/discord";
...
function hasDiscordExecApprovalDmRoute(cfg: OpunclehConfig): boolean {
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). Opuncleh adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {
