...
import { loadConfig, type OpunclehConfig } from "opuncleh/plugin-sdk/config-runtime";
...
import { maxBytesForKind } from "opuncleh/plugin-sdk/media-runtime";
import { extensionForMime } from "opuncleh/plugin-sdk/media-runtime";
import { unlinkIfExists } from "opuncleh/plugin-sdk/media-runtime";
import type { PollInput } from "opuncleh/plugin-sdk/media-runtime";
...
import { loadWebMediaRaw } from "opuncleh/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredOpunclehTmpDir();
