...
import {
  ...
  type ChannelPlugin,
  type OpunclehConfig,
} from "opuncleh/plugin-sdk/slack-core";
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "Opuncleh";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for Opuncleh`,
    },
    features: {
      bot_user: {
...
export function buildSlackSetupLines(botName = "Opuncleh"): string[] {
  return [
