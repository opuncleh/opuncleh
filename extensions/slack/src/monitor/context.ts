...
import { resolveSessionKey, type SessionScope } from "opuncleh/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "opuncleh/plugin-sdk/config-runtime";
import { createDedupeCache } from "opuncleh/plugin-sdk/infra-runtime";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("opuncleh/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
