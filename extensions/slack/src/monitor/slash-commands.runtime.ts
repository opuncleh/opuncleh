...
type BuildCommandTextFromArgs =
  typeof import("opuncleh/plugin-sdk/reply-runtime").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("opuncleh/plugin-sdk/reply-runtime").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("opuncleh/plugin-sdk/reply-runtime").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("opuncleh/plugin-sdk/reply-runtime").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("opuncleh/plugin-sdk/reply-runtime").resolveCommandArgMenu;
