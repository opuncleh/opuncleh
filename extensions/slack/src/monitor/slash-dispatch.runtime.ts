...
import { resolveMarkdownTableMode as resolveMarkdownTableModeImpl } from "opuncleh/plugin-sdk/config-runtime";
import {
...
import { resolveAgentRoute as resolveAgentRouteImpl } from "opuncleh/plugin-sdk/routing";
import { deliverSlackSlashReplies as deliverSlackSlashRepliesImpl } from "./replies.js";

type ResolveChunkMode = typeof import("opuncleh/plugin-sdk/reply-runtime").resolveChunkMode;
type FinalizeInboundContext =
  typeof import("opuncleh/plugin-sdk/reply-runtime").finalizeInboundContext;
type DispatchReplyWithDispatcher =
  typeof import("opuncleh/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher;
type ResolveConversationLabel =
  typeof import("opuncleh/plugin-sdk/channel-runtime").resolveConversationLabel;
type CreateReplyPrefixOptions =
  typeof import("opuncleh/plugin-sdk/channel-runtime").createReplyPrefixOptions;
type RecordInboundSessionMetaSafe =
  typeof import("opuncleh/plugin-sdk/channel-runtime").recordInboundSessionMetaSafe;
type ResolveMarkdownTableMode =
  typeof import("opuncleh/plugin-sdk/config-runtime").resolveMarkdownTableMode;
type ResolveAgentRoute = typeof import("opuncleh/plugin-sdk/routing").resolveAgentRoute;
