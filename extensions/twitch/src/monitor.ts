...
import type { ReplyPayload, OpunclehConfig } from "opuncleh/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "opuncleh/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as OpunclehConfig;
