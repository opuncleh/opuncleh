...
import { createAccountListHelpers, type OpunclehConfig } from "opuncleh/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: OpunclehConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: OpunclehConfig; accountId?: string | null }) {
