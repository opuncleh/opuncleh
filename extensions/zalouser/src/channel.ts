...
import { buildAccountScopedDmSecurityPolicy } from "opuncleh/plugin-sdk/channel-policy";
import type {
...
} from "opuncleh/plugin-sdk/zalouser";
import {
...
function resolveZalouserOutboundChunkMode(cfg: OpunclehConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: OpunclehConfig, accountId?: string) {
