...
import { buildOauthProviderAuthResult } from "opuncleh/plugin-sdk/provider-auth";
import { fetchGeminiUsage } from "opuncleh/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: OpunclehPluginApi) {
