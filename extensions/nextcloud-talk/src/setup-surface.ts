...
import { hasConfiguredSecretInput } from "opuncleh/plugin-sdk/config-runtime";
import { DEFAULT_ACCOUNT_ID } from "opuncleh/plugin-sdk/routing";
import { setSetupChannelEnabled } from "opuncleh/plugin-sdk/setup";
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "Opuncleh" "<shared-secret>" "<webhook-url>" --feature reaction',
