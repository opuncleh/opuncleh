...
const CONFIG_KEY = Symbol.for("opuncleh:testConfigMock");
...
vi.mock("opuncleh/plugin-sdk/media-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("opuncleh/plugin-sdk/media-runtime")>();
...
vi.mock("@whiskeysockets/baileys", () => {
  ...
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("opuncleh:lastSocket")] =
    created.lastSocket;
  return created.mod;
});
...
export function getLastSocket(): MockBaileysSocket {
  const getter = (globalThis as Record<PropertyKey, unknown>)[Symbol.for("opuncleh:lastSocket")];
  if (typeof getter === "function") {
