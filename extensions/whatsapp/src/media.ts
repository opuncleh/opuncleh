...
import { SafeOpenError, readLocalFileSafely } from "opuncleh/plugin-sdk/infra-runtime";
import type { SsrFPolicy } from "opuncleh/plugin-sdk/infra-runtime";
import { type MediaKind, maxBytesForKind } from "opuncleh/plugin-sdk/media-runtime";
import { fetchRemoteMedia } from "opuncleh/plugin-sdk/media-runtime";
import {
  convertHeicToJpeg,
  hasAlphaChannel,
  optimizeImageToPng,
...
import { getDefaultMediaLocalRoots } from "opuncleh/plugin-sdk/media-runtime";
import { detectMime, extensionForMime, kindFromMime } from "opuncleh/plugin-sdk/media-runtime";
import { logVerbose, shouldLogVerbose } from "opuncleh/plugin-sdk/runtime-env";
import { resolveUserPath } from "opuncleh/plugin-sdk/text-runtime";
...
async function assertLocalMediaAllowed(
  ...
  // Hardening: the default allowlist includes the Opuncleh temp dir, and tests/CI may
