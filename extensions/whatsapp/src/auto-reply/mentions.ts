...
import { buildMentionRegexes, normalizeMentionText } from "opuncleh/plugin-sdk/reply-runtime";
import { isSelfChatMode, jidToE164, normalizeE164 } from "opuncleh/plugin-sdk/text-runtime";
