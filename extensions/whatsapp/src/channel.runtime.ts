import { monitorWebChannel as monitorWebChannelImpl } from "opuncleh/plugin-sdk/whatsapp";
...
type MonitorWebChannel = typeof import("opuncleh/plugin-sdk/whatsapp").monitorWebChannel;
