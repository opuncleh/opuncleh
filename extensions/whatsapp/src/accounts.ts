...
import type { DmPolicy, GroupPolicy, WhatsAppAccountConfig } from "opuncleh/plugin-sdk/whatsapp";
...
export function listWhatsAppAuthDirs(cfg: OpunclehConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpunclehConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpunclehConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpunclehConfig): ResolvedWhatsAppAccount[] {
