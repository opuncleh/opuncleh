...
Nostr DM channel plugin for Opuncleh using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Opuncleh. It enables your bot to:
...
# Configure opuncleh to use local relay
