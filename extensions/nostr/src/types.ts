...
} from "opuncleh/plugin-sdk/account-id";
import type { OpunclehConfig } from "opuncleh/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: OpunclehConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: OpunclehConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: OpunclehConfig): string {
