import type { ChannelSetupAdapter } from "opuncleh/plugin-sdk/channel-runtime";
...
import type { ChannelSetupDmPolicy } from "opuncleh/plugin-sdk/setup";
import type { ChannelSetupWizard } from "opuncleh/plugin-sdk/setup";
import { formatDocsLink } from "opuncleh/plugin-sdk/setup";
import type { WizardPrompter } from "opuncleh/plugin-sdk/setup";
...
function setNostrDmPolicy(cfg: OpunclehConfig, dmPolicy: DmPolicy): OpunclehConfig {
...
function setNostrAllowFrom(cfg: OpunclehConfig, allowFrom: string[]): OpunclehConfig {
