import { AllowFromListSchema, DmPolicySchema } from "opuncleh/plugin-sdk/compat";
import { MarkdownConfigSchema, buildChannelConfigSchema } from "opuncleh/plugin-sdk/nostr";
import { z } from "zod";
