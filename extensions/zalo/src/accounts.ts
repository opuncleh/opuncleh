...
import { createAccountListHelpers, type OpunclehConfig } from "opuncleh/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: OpunclehConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: OpunclehConfig): ResolvedZaloAccount[] {
