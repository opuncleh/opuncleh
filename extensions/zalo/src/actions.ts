...
import type {
  ...
  OpunclehConfig,
} from "opuncleh/plugin-sdk/zalo";
import { extractToolSend, jsonResult, readStringParam } from "opuncleh/plugin-sdk/zalo";
...
function listEnabledAccounts(cfg: OpunclehConfig) {
