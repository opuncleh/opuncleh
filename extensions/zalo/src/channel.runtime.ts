...
import { PAIRING_APPROVED_MESSAGE } from "opuncleh/plugin-sdk/zalo";
...
export async function notifyZaloPairingApproval(params: {
  cfg: import("opuncleh/plugin-sdk/zalo").OpunclehConfig;
  id: string;
}) {
...
export async function startZaloGatewayAccount(
  ctx: Parameters<
    NonNullable<
      NonNullable<import("opuncleh/plugin-sdk/zalo").ChannelPlugin["gateway"]>["startAccount"]
    >
  >[0],
) {
