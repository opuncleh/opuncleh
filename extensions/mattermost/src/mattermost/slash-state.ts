...
import type { OpunclehPluginApi } from "opuncleh/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("opuncleh/plugin-sdk/mattermost").OpunclehConfig;
    runtime: import("opuncleh/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: OpunclehPluginApi) {
