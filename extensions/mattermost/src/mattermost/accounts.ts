...
import { createAccountListHelpers, type OpunclehConfig } from "opuncleh/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: OpunclehConfig): ResolvedMattermostAccount[] {
