import {
  ...
  type OpunclehConfig,
} from "opuncleh/plugin-sdk/mattermost";
export { createDedupeCache, rawDataToString } from "opuncleh/plugin-sdk/mattermost";
...
function listAgents(cfg: OpunclehConfig): AgentEntry[] {
...
export function resolveIdentityName(cfg: OpunclehConfig, agentId: string): string | undefined {
