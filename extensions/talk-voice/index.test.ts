...
import type { OpunclehPluginCommandDefinition } from "../../test/helpers/extensions/plugin-command.js";
...
function createHarness(config: Record<string, unknown>) {
  ...
  const api = {
    runtime,
    registerCommand: vi.fn((definition: OpunclehPluginCommandDefinition) => {
      command = definition;
    }),
  };
