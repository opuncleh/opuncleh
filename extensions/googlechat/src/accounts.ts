...
import { isSecretRef } from "opuncleh/plugin-sdk/googlechat";
import { createAccountListHelpers, type OpunclehConfig } from "opuncleh/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: OpunclehConfig): ResolvedGoogleChatAccount[] {
