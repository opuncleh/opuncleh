...
import { normalizeScpRemoteHost } from "opuncleh/plugin-sdk/infra-runtime";
import { waitForTransportReady } from "opuncleh/plugin-sdk/infra-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "opuncleh/plugin-sdk/media-runtime";
import { kindFromMime } from "opuncleh/plugin-sdk/media-runtime";
import { resolveTextChunkLimit } from "opuncleh/plugin-sdk/reply-runtime";
...
import { createReplyDispatcher } from "opuncleh/plugin-sdk/reply-runtime";
import { danger, logVerbose, shouldLogVerbose, warn } from "opuncleh/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "opuncleh/plugin-sdk/security-runtime";
 ...
 *   exec ssh -T opuncleh@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., opuncleh@192.168.64.3)
