...
import type { IMessageAccountConfig } from "opuncleh/plugin-sdk/imessage";
...
function mergeIMessageAccountConfig(cfg: OpunclehConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OpunclehConfig): ResolvedIMessageAccount[] {
