...
export const imessageDmPolicy: ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: OpunclehConfig) => cfg.channels?.imessage?.dmPolicy ?? "pairing",
...
function resolveIMessageCliPath(params: { cfg: OpunclehConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure Opuncleh has Full Disk Access to Messages DB.",
