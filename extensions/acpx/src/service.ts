import type {
  ...
  PluginLogger,
} from "opuncleh/plugin-sdk/acpx";
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "opuncleh/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: OpunclehPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: OpunclehPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
