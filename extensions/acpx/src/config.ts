...
import type { OpunclehPluginConfigSchema } from "opuncleh/plugin-sdk/acpx";
...
function isAcpxPluginRoot(dir: string): boolean {
  return (
    fs.existsSync(path.join(dir, "opuncleh.plugin.json")) &&
...
export function createAcpxPluginConfigSchema(): OpunclehPluginConfigSchema {
  return {
