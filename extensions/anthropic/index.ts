...
import { parseDurationMs } from "opuncleh/plugin-sdk/cli-runtime";
import {
  definePluginEntry,
  type ProviderAuthContext,
  type ProviderResolveDynamicModelContext,
  type ProviderRuntimeModel,
} from "opuncleh/plugin-sdk/core";
import {
  ...
  validateApiKeyInput,
} from "opuncleh/plugin-sdk/provider-auth";
import { normalizeModelCompat } from "opuncleh/plugin-sdk/provider-models";
import { fetchClaudeUsage } from "opuncleh/plugin-sdk/provider-usage";
...
function buildAnthropicAuthDoctorHint(params: {
  ...
  return [
    ...
    `Fix: run "${formatCliCommand("opuncleh doctor --yes")}"`,
  ].join("\n");
}
