...
function setFeishuDmPolicy(cfg: OpunclehConfig, dmPolicy: DmPolicy): OpunclehConfig {
...
function setFeishuAllowFrom(cfg: OpunclehConfig, allowFrom: string[]): OpunclehConfig {
...
function setFeishuGroupAllowFrom(cfg: OpunclehConfig, groupAllowFrom: string[]): OpunclehConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
...
function isFeishuConfigured(cfg: OpunclehConfig): boolean {
...
const feishuDmPolicy: ChannelSetupDmPolicy = {
  ...
  setPolicy: (cfg, policy) => setFeishuDmPolicy(cfg as OpunclehConfig, policy),
