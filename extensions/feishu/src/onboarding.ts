...
function setFeishuDmPolicy(cfg: LobstrbotConfig, dmPolicy: DmPolicy): LobstrbotConfig {
...
function setFeishuAllowFrom(cfg: LobstrbotConfig, allowFrom: string[]): LobstrbotConfig {
...
function setFeishuGroupAllowFrom(cfg: LobstrbotConfig, groupAllowFrom: string[]): LobstrbotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
