import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "opuncleh/plugin-sdk/account-id";
import type { LobstrbotConfig } from "opuncleh/plugin-sdk/feishu";
 ...
 */
function listConfiguredAccountIds(cfg: LobstrbotConfig): string[] {
 ...
 */
export function listFeishuAccountIds(cfg: LobstrbotConfig): string[] {
 ...
 */
export function resolveDefaultFeishuAccountSelection(cfg: LobstrbotConfig): {
  accountId: string;
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: LobstrbotConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: LobstrbotConfig, accountId: string): FeishuConfig {
 ...
 */
export function listEnabledFeishuAccounts(cfg: LobstrbotConfig): ResolvedFeishuAccount[] {
