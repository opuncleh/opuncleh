...
import type { OpunclehPluginApi } from "opuncleh/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: OpunclehPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<OpunclehPluginApi, "config">;
