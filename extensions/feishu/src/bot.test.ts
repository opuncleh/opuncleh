import type { LobstrbotConfig, PluginRuntime, RuntimeEnv } from "opuncleh/plugin-sdk/feishu";
...
async function dispatchMessage(params: { cfg: LobstrbotConfig; event: FeishuMessageEvent }) {
