import type { MSTeamsTeamConfig } from "opuncleh/plugin-sdk/msteams";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setMSTeamsDmPolicy(cfg: OpunclehConfig, dmPolicy: DmPolicy) {
...
function setMSTeamsAllowFrom(cfg: OpunclehConfig, allowFrom: string[]): OpunclehConfig {
...
function listMSTeamsGroupEntries(cfg: OpunclehConfig): string[] {
