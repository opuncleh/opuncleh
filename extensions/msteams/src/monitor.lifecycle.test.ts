...
import type { OpunclehConfig, RuntimeEnv } from "opuncleh/plugin-sdk/msteams";
...
vi.mock("opuncleh/plugin-sdk/msteams", () => ({
...
function createConfig(port: number): OpunclehConfig {
  return {
    channels: {
      msteams: {
        enabled: true,
