...
import { normalizeSecretInput } from "opuncleh/plugin-sdk/provider-auth";
...
type WebSearchConfig = NonNullable<OpunclehConfig["tools"]>["web"] extends infer Web
  ? Web extends { search?: infer Search }
    ? Search
    : undefined
  : undefined;

type WebFetchConfig = NonNullable<OpunclehConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: OpunclehConfig): WebSearchConfig {
...
function resolveFetchConfig(cfg?: OpunclehConfig): WebFetchConfig {
...
export function resolveFirecrawlSearchConfig(cfg?: OpunclehConfig): FirecrawlSearchConfig {
...
export function resolveFirecrawlFetchConfig(cfg?: OpunclehConfig): FirecrawlFetchConfig {
...
export function resolveFirecrawlApiKey(cfg?: OpunclehConfig): string | undefined {
...
export function resolveFirecrawlBaseUrl(cfg?: OpunclehConfig): string {
  const search = resolveFirecrawlSearchConfig(cfg);
  const fetch = resolveFirecrawlFetchConfig(cfg);
  const configured =
...
export function resolveFirecrawlOnlyMainContent(cfg?: OpunclehConfig, override?: boolean): boolean {
...
export function resolveFirecrawlMaxAgeMs(cfg?: OpunclehConfig, override?: number): number {
