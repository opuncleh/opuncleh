...
import { optionalStringEnum } from "opuncleh/plugin-sdk/agent-runtime";
import { jsonResult, readNumberParam, readStringParam } from "opuncleh/plugin-sdk/agent-runtime";
...
export function createFirecrawlScrapeTool(api: OpunclehPluginApi) {
  return {
