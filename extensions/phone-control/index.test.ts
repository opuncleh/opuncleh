...
function createApi(params: {
  ...
  return createTestPluginApi({
    ...
    } as OpunclehPluginApi["runtime"],
    registerCommand: params.registerCommand,
  }) as OpunclehPluginApi;
}
...
describe("phone-control plugin", () => {
  it("arms sms.send as part of the writes group", async () => {
    const stateDir = await fs.mkdtemp(path.join(os.tmpdir(), "opuncleh-phone-control-test-"));
    try {
      ...
      let command: OpunclehPluginCommandDefinition | undefined;
