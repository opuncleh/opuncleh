import { setSetupChannelEnabled, type ChannelSetupWizard } from "opuncleh/plugin-sdk/setup";
import { detectBinary, installSignalCli } from "opuncleh/plugin-sdk/setup-tools";
