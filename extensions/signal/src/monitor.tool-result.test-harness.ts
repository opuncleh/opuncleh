import { resetSystemEventsForTest } from "opuncleh/plugin-sdk/infra-runtime";
...
vi.mock("opuncleh/plugin-sdk/config-runtime", async (importOriginal) => {
  ...
  return {
    ...actual,
    resolveStorePath: vi.fn(() => "/tmp/opuncleh-sessions.json"),
...
vi.mock("opuncleh/plugin-sdk/infra-runtime", () => ({
