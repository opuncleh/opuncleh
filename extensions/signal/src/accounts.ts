...
import type { SignalAccountConfig } from "opuncleh/plugin-sdk/signal";
...
function mergeSignalAccountConfig(cfg: OpunclehConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OpunclehConfig): ResolvedSignalAccount[] {
