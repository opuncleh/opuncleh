...
export async function resolveTlonSetupConfigured(cfg: OpunclehConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: OpunclehConfig): Promise<string[]> {
