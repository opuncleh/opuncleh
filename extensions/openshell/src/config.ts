...
import type { OpunclehPluginConfigSchema } from "opuncleh/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): OpunclehPluginConfigSchema {
