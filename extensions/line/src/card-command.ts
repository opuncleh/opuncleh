import type { LineChannelData, OpunclehPluginApi, ReplyPayload } from "opuncleh/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: OpunclehPluginApi): void {
  api.registerCommand({
    name: "card",
