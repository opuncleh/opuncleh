import type { ChannelSetupAdapter, OpunclehConfig } from "opuncleh/plugin-sdk/setup";
import { DEFAULT_ACCOUNT_ID } from "opuncleh/plugin-sdk/setup";
...
export function isLineConfigured(cfg: OpunclehConfig, accountId: string): boolean {
