import type { OpunclehConfig, PluginRuntime, ResolvedLineAccount } from "opuncleh/plugin-sdk/line";
...
async function runLogoutScenario(params: { cfg: OpunclehConfig; accountId: string }): Promise<{
