...
import { resolveChannelMediaMaxBytes, type OpunclehConfig } from "opuncleh/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: OpunclehConfig; accountId?: string }): string[] {
