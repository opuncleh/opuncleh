...
import { createAccountListHelpers, type OpunclehConfig } from "opuncleh/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: OpunclehConfig): ResolvedBlueBubblesAccount[] {
