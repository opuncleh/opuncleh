...
This directory contains the **BlueBubbles external channel plugin** for Opuncleh.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `opuncleh/plugin-sdk` helpers.
