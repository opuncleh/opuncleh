...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.opuncleh/opuncleh.json`
...
- The script prints a `MEDIA:` line for Opuncleh to auto-attach on supported chat providers.
