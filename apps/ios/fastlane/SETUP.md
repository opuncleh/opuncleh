...
ASC_KEYCHAIN_SERVICE=opuncleh-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.opuncleh.client
# or
...
- The beta flow regenerates `apps/ios/Opuncleh.xcodeproj` from `apps/ios/project.yml` before archiving
