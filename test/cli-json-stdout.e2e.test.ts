    ...
    await withTempHome(
      async (tempHome) => {
        ...
        const env = {
          ...
          OPUNCLEH_TEST_FAST: "1",
        };
        delete env.OPUNCLEH_HOME;
        delete env.OPUNCLEH_STATE_DIR;
        delete env.OPUNCLEH_CONFIG_PATH;
        delete env.VITEST;

        const entry = path.resolve(process.cwd(), "opuncleh.mjs");
