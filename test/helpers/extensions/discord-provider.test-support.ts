import type { OpunclehConfig } from "opuncleh/plugin-sdk/discord";
...
const providerMonitorTestMocks: ProviderMonitorTestMocks = vi.hoisted(() => {
  ...
  return {
    ...
    getAcpSessionStatusMock: vi.fn(
      async (_params: { cfg: OpunclehConfig; sessionKey: string; signal?: AbortSignal }) => ({
        state: "idle",
      }),
    ),
...
export const baseConfig = (): OpunclehConfig =>
  ({
    channels: {
      discord: {
        accounts: {
...
vi.mock("opuncleh/plugin-sdk/acp-runtime", async () => {
  const actual = await vi.importActual<typeof import("opuncleh/plugin-sdk/acp-runtime")>(
    "opuncleh/plugin-sdk/acp-runtime",
  );
  return {
    ...actual,
...
vi.mock("opuncleh/plugin-sdk/reply-runtime", async () => {
  const actual = await vi.importActual<typeof import("opuncleh/plugin-sdk/reply-runtime")>(
    "opuncleh/plugin-sdk/reply-runtime",
  );
  return {
    ...actual,
...
vi.mock("opuncleh/plugin-sdk/config-runtime", async () => {
  const actual = await vi.importActual<typeof import("opuncleh/plugin-sdk/config-runtime")>(
    "opuncleh/plugin-sdk/config-runtime",
  );
  return {
    ...actual,
...
vi.mock("opuncleh/plugin-sdk/runtime-env", async () => {
  const actual = await vi.importActual<typeof import("opuncleh/plugin-sdk/runtime-env")>(
    "opuncleh/plugin-sdk/runtime-env",
  );
  return {
    ...actual,
...
vi.mock("opuncleh/plugin-sdk/infra-runtime", async () => {
  const actual = await vi.importActual<typeof import("opuncleh/plugin-sdk/infra-runtime")>(
    "opuncleh/plugin-sdk/infra-runtime",
  );
  return {
    ...actual,
