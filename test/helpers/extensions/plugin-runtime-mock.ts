import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "opuncleh/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "opuncleh/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "opuncleh/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/opuncleh"),
    },
    modelAuth: {
