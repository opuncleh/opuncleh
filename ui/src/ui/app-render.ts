...
const UPDATE_BANNER_DISMISS_KEY = "opuncleh:control-ui:update-banner-dismissed:v1";
      ...
      <div class="sidebar-header">
        ${
          ...
          <div class="sidebar-brand">
            <img class="sidebar-brand__logo" src="${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"}" alt="Opuncleh" />
            <span class="sidebar-brand__title">Opuncleh</span>
          </div>
        `
        }
        <button
