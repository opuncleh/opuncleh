...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "opuncleh-control-ui",
    clientVersion,
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as OpunclehApp);
      void loadAgents(host as unknown as OpunclehApp);
      void loadHealthState(host as unknown as OpunclehApp);
      void loadNodes(host as unknown as OpunclehApp, { quiet: true });
      void loadDevices(host as unknown as OpunclehApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as OpunclehApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as OpunclehApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as OpunclehApp, payload);
