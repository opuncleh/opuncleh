...
import { OpunclehApp } from "./app.ts";
...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as OpunclehApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as OpunclehApp).resetToolStream();
  (state as unknown as OpunclehApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      <button
        ...
        @click=${async () => {
          const app = state as unknown as OpunclehApp;
