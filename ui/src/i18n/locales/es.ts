...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.opuncleh/opuncleh.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde opuncleh dashboard --no-open en tu escritorio.",
    },
    insecure: {
